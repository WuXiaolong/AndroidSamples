...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        setShadow(context, shadowLeft, EDGE_LEFT);
        setShadow(context, shadowRight, EDGE_RIGHT);
        setShadow(context, shadowBottom, EDGE_BOTTOM);
        a.recycle();
     ...
     * @see #EDGE_BOTTOM
     */
    public void setShadow(Context context, int resId, int edgeFlag) {
        setShadow(ActivityCompat.getDrawable(context, resId), edgeFlag);
    }
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if ((mTrackingEdge & EDGE_LEFT) != 0) {
                //getIntrinsicWidth()和getIntrinsicHeight()取得Drawable的宽高，dp为单位
